...
import { itemsLong, LongTextMultiLine } from "."
        ...
        >
            {itemsLong.map((item, i) => (
                <MuiMenuItem
                    ...
                    sx={{ maxWidth: "200px" }}
                >
                    <LongTextMultiLine>{item.text}</LongTextMultiLine>
                </MuiMenuItem>
            ))}
        </MuiSelect>
    </MuiBox>
...
export const WithLongTextMultiLine = Template.bind({})
WithLongTextMultiLine.args = {
    variant: "outlined",
    color: "primary",
    size: "small",
